...
[![Version](https://img.shields.io/badge/version-1.3.0-20e4f4)](./CHANGELOG.md)
...
- In-app Pwnagotchi whitelist management and confirmation-bound capture cleanup.
- Gzip-compressed HTML and lazy map loading for faster Bluetooth access.
...
sudo wget -O /usr/local/share/pwnagotchi/custom-plugins/A_pwmenu.py \
  https://raw.githubusercontent.com/newfpv/pwmenu/v1.3.0/A_pwmenu.py
